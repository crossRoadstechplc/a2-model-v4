...
export const kpiTargetDefinitions: KpiTargetDefinition[] = [
  {
    ...
    format: 'currencyM',
    module: 'fleet',
    description: 'Combined workbook power-sales revenue in the terminal period.',
    trace: ['Fleet power demand', 'Power units sold', 'Sale price per unit', 'Revenue'],
  },
  {
    id: 'fleet_ebitda',
    label: 'Fleet EBITDA',
    format: 'currencyM',
    module: 'fleet',
    description: 'Combined workbook EBITDA in the terminal period.',
    trace: ['Power sales + subscriptions', 'Power cost + opex + battery lease', 'EBITDA'],
  },
  {
  ...
  },
  {
    ...
    trace: ['Fleet throughput demand', 'Swap fees + subscriptions', 'Workbook subscription anchor', 'Platform revenue'],
  },
  {
    id: 'platform_sites',
  ...
  },
  {
    ...
    trace: ['Power sales', 'Lease income', 'Platform revenue share', 'Energy revenue'],
  },
  {
  ...
  },
  {
    ...
    format: 'currencyM',
    module: 'consolidated',
    description: 'Workbook-anchored consolidated revenue after eliminations.',
    trace: ['Power sales + subscriptions', 'Internal flow eliminations', 'Consolidated revenue'],
  },
  {
    ...
    format: 'percent',
    module: 'consolidated',
    description: 'Workbook-anchored consolidated EBITDA margin in the terminal period.',
